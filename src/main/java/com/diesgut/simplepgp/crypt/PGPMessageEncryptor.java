...
import com.diesgut.simplepgp.util.BasePGP;
import com.diesgut.simplepgp.util.IOUtils;

public class PGPMessageEncryptor extends BasePGP implements IMessageEncryptor {
	 ...
	 * @throws Exception 
	   */
	  @Override
	  public boolean encrypt(InputStream publicKeyOfRecipient, String inputDataName, InputStream plainInputData, OutputStream target) throws Exception {
	 ...
	 * @throws Exception 
	   */
	  @Override
	  public boolean encrypt(InputStream publicKeyOfRecipient, InputStream privateKeyOfSender, String userIdOfSender, String passwordOfSendersPrivateKey, String inputDataName, InputStream plainInputData, OutputStream target) throws Exception {
...
//	      result &= false;
	    	throw new Exception("No public key found for encryption!");
	    }
	    return result;
	  }
	   ...
	   */
	  @Override
	  public boolean decrypt(String passwordOfReceiversPrivateKey, InputStream privateKeyOfReceiver, InputStream encryptedData, OutputStream target) throws Exception{
	 ...
	 * @throws Exception 
	   */
	  @Override
	  public boolean decrypt(String passwordOfReceiversPrivateKey, InputStream privateKeyOfReceiver, InputStream publicKeyOfSender, InputStream encryptedData, OutputStream target) throws Exception {
